  ...
  return (
    <div className='max-w-[1400px] w-full mx-auto p-5 bg-[#fecfd5] space-y-7 my-15 rounded-3xl tracking-tighter'>
      ...
      < div className='flex  lg:flex-nowrap flex-wrap justify-center items-center space-x-6 space-y-5'>
        <div className='flex flex-col  bg-[#e1ecfe] gap-[10rem] xl:gap-[14em] p-9 w-full max-w-[450px] min-h-[400px] lg:min-h-[600px] rounded-xl'>
        ...
        <div className='flex flex-col bg-[#16ab59] gap-[10rem] xl:gap-[13em] p-9 w-full max-w-[450px] min-h-[400px] lg:min-h-[600px] rounded-xl'>
        ...
        <div className='flex flex-col bg-[#ff7714] gap-[10rem] xl:gap-[13em] p-9 w-full max-w-[450px] min-h-[400px] lg:min-h-[600px] rounded-xl'>
            <div className="space-y-4">
